...
import { getCurrentUserController, loginUserController, logoutUserController, registerUserController, updateProfileController, deleteMyAccountController } from '../controllers/auth/auth.controller.js';
import { resendVerificationEmailController, updateEmailController, verifyUserEmailController } from '../controllers/auth/verification.controller.js';
import { forgotPasswordController, resetPasswordController, updatePasswordController } from '../controllers/auth/password.controller.js';
import { requireAuth } from '../middlewares/auth.middleware.js';
// import passport from '../config/passport.config.js';
// import { googleCallbackController, facebookCallbackController } from '../controllers/auth/auth.controller.js';
...
// NOTE: OAuth routes will be implemented in part 2
