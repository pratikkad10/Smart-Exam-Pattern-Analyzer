...
import { generateAndSaveToken, generateAuthToken } from "../../services/token/token.service.js";
import { findUserByEmail, createUser, findUserById } from "../../services/user/user.service.js";
...
export const deleteMyAccountController = async (req, res) => {
    try {
        ...
        const { deleteUser } = await import("../../services/user/user.service.js");
...
// NOTE: OAuth will be implemented in part 2
